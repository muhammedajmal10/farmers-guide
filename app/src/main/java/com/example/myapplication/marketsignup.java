...
public class marketsignup extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marketsignup);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            User2 user2 = new User2(fullname,number,email,password);
                            ...
                            FirebaseDatabase.getInstance().getReference("market")
                                    ...
                                    .setValue(user2).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                Toast.makeText(marketsignup.this, "Registered successfully", Toast.LENGTH_LONG).show();
                                                startActivity(new Intent(marketsignup.this,market.class));
                                            }else{
                                                Toast.makeText(marketsignup.this, "Failed to register! Try Again!", Toast.LENGTH_LONG).show();
                                            }
                                        }
                                    });
                        }else{
                            Toast.makeText(marketsignup.this, "Failed to register!", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
